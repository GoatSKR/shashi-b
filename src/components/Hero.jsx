            ...
            <div className=" bg-no-repeat bg-right-bottom bg-contain"
                ...
                <nav className="w-full">
                    ...
                    <div className="flex items-left justify-between px-2">
                        ...
                        <div className="hidden md:flex items-center justify-around gap-2 relative">
                            {navLinks.map((link) => (
                        ...
                        <div className={`md:hidden ${isOpen ? "block" : "hidden"} bg-black py-2`}>
                            {navLinks.map((link) => (
                                <React.Fragment key={link.id}>
                                    <a
                                        href={`#${link.id}`}
                                        key={link.id}
                                        className="block text-white font-Helvet px-3 py-2 font-light border-b border-gray-700 hover:bg-gray-800 relative"
